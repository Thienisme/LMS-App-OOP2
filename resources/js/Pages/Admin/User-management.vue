      ...
      <div class="h-full">
        ...
        <div class="py-5">
          <div class="mx-w-7xl mx-auto">
            <div class="bg-white overflow-hidden shadow sm:rounded-lg px-4 py-4">
              <!-- Flash Message -->
                ...
                <DataTable class="display nowrap h-full">
                  <thead>
                    <tr class="bg-gray-100">
                      ...
                      <th class="border px-4 py-2 text-left">Student Code</th>
                  ...
                  <tbody>
                    <tr v-for="(row, index) in users" :key="row.id">
                      ...
                      <td class="border px-4 py-2">{{ row.student_code }}</td>
